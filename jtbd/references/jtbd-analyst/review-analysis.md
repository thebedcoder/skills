# App Store / Review Site Analysis Guide
...
- 3+ reviews mentioning the same pain → High frequency → ⭐⭐⭐
- 1–2 reviews mentioning pain → Medium → ⭐⭐
- Single mention, possibly edge case → Low → ⭐

## Voice Sample Criteria for Reviews

Pick quotes that are:
- Emotionally specific (not "great app")
- Past-tense narrative (describes a real situation)
- Short enough to use in ad copy (under 30 words ideal)
